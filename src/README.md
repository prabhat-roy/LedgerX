...
- [`platform/`](platform/) â€” gateway, BFFs, GraphQL, rate-limit, idempotency, saga (12)
- [`core-banking/`](core-banking/) â€” accounts, ledger, balances, EOD, accounting (12)
- [`payments/`](payments/) â€” gateway, router, SWIFT, SEPA, UPI, ACH, RTP (12)
- [`cards/`](cards/) â€” issuance, authorisation, lifecycle, virtual, tokenisation (12)
- [`lending/`](lending/) â€” origination, underwriting, scoring, disbursement, collections (12)
- [`kyc/`](kyc/) â€” KYC, AML, OCR, screening, FATCA/CRS (12)
- [`fraud-risk/`](fraud-risk/) â€” detection, monitoring, scoring, AML graph, ATO (12)
- [`wealth/`](wealth/) â€” portfolio, robo-advisor, market-data, OMS, custody (12)
- [`insurance/`](insurance/) â€” policy, claims, IFRS 17, reinsurance, actuarial (12)
- [`treasury/`](treasury/) â€” FX, liquidity, cash pooling, hedging, ALM (12)
- [`compliance/`](compliance/) â€” AML reporting, BASEL III, MiFID II, EMIR (12)
- [`open-banking/`](open-banking/) â€” consent, AIS, PIS, FAPI, VRP (12)
- [`notifications/`](notifications/) â€” orchestrator, SMS, email, push, IVR (10)
- [`customer-360/`](customer-360/) â€” profile, relationship, segmentation, CLV (10)
- [`analytics/`](analytics/) â€” revenue, churn, recommendation, profitability (10)
- [`identity/`](identity/) â€” auth, MFA, SSO, device-trust, PAM, SPIFFE (12)
- [`reconciliation/`](reconciliation/) â€” settlement, nostro, scheme recon (10)
