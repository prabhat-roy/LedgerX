# TOOLS.md — every OSS tool registered for LedgerX

This file is the single inventory of every OSS tool wired up for LedgerX.
...
| workflow | [drools](workflow/drools/) | `workflow/drools/` (scaffold) |
...
| workflow | [openl-tablets](workflow/openl-tablets/) | `workflow/openl-tablets/` (scaffold) |
| workflow | [prefect](workflow/prefect/) | `workflow/prefect/` (scaffold) |
| workflow | [zeebe](workflow/zeebe/) | `workflow/zeebe/` (scaffold) |
| domain-oss | [hyperledger-indy](domain-oss/hyperledger-indy/) | `domain-oss/hyperledger-indy/` (deployable) |
| domain-oss | [iso20022](domain-oss/iso20022/) | `domain-oss/iso20022/` (deployable) |
| domain-oss | [pinot](domain-oss/pinot/) | `domain-oss/pinot/` (deployable) |
